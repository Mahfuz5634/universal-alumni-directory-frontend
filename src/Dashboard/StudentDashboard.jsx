        ...
        <header className="bg-white border-b border-slate-200 px-4 md:px-6 py-3 flex items-center justify-between shrink-0 z-30 shadow-sm">
          ...
          <div className="flex items-center gap-3 ml-auto">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">{user?.role || "Student"}</p>
            </div>
                   ...
                   {displayedAlumni.map(alumni => (
                     <div key={alumni._id} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-indigo-200 transform transition-all hover:-translate-y-1 duration-300 flex flex-col relative group">
                       ...
                       <div className="flex items-center gap-2 pt-4 border-t border-slate-100 mt-auto">
                          <button onClick={() => startConversation(alumni)} className="flex-1 bg-indigo-50 border border-indigo-200 text-indigo-700 text-center py-2.5 rounded-xl text-sm font-bold hover:bg-indigo-600 hover:text-white transition-colors flex items-center justify-center gap-2">
                            <MessageSquare className="w-4 h-4" /> <span className="hidden lg:inline">Message</span>
                          </button>
                          {alumni.email && (
                            <a href={`mailto:${alumni.email}`} title="Email" className="p-2.5 bg-slate-50 text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl border border-slate-200 transition-colors shrink-0">
           ...
           {activeTab === "messages" && (
             <div className="p-4 md:p-8 lg:px-12 lg:py-10 h-full max-w-7xl mx-auto flex flex-col animate-in fade-in duration-500 slide-in-from-bottom-4">
               <div className="mb-6 shrink-0">
                 ...
                 <p className="text-slate-500 mt-2 text-sm">Connect directly with alumni and your peers.</p>
               </div>
